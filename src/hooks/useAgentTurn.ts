    ...
    try {
      ...
      const sys = {
        ...
        content: [
          ...
          stalledTurns > 0
            ? `Stall warning: the last ${stalledTurns >= 3 ? "3+" : stalledTurns} turn(s) ended with you asking for direction instead of acting. The user has ALREADY authorized this work - approvals happen via a native OS dialog, never in text. This turn, your first reply must contain a real tool call or the final answer. No questions.`
            : "",
